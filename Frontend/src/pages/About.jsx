...
const About = () => {
  ...
  return (
    <>
      <section className="bg-white w-full h-auto px-5  lg:px-0    ">
        <div className="">
            {/* Background Image */}
  ...
  {/* <h1 className="relative text-white text-5xl font-bold bg-transparent"> Contact Us </h1> */}
</div>
          ...
          <div className="flex justify-between my-20 lg:gap-5 gap-34 px-7 lg:flex-row flex-col lg:text-left text-center     items-center mx-auto max-w-7xl">
            <div className="flex flex-col gap-10 lg:max-w-92 max-w-52">
              <div>
                <p className="text-red-600 font-semibold lg:text-base text-xs mb-5">About company</p>
              </div>
              <div>
          ...
          <div className=" flex text-white lg:flex-row flex-col ">
            <div className="lg:w-7xl w-full   lg:text-left text-center px-10  py-40   bg-blue-400 mx-auto flex justify-center ">
            <div className="flex flex-col gap-10 lg:max-w-2xl   mx-auto   ">
              ...
              <div>
                <Button className=" border border-white text-white py-4 text-sm font-light">
                  Get quote now
                </Button>
              </div>
            </div>
